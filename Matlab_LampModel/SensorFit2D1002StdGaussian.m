function SensorFit2D1002StdGaussian(dist,std)
%SENSORFIT2D1002STDGAUSSIAN    Create plot of datasets and fits
%   SENSORFIT2D1002STDGAUSSIAN(DIST,STD)
...
%    Unweighted
%
% This function was automatically generated on 02-Oct-2006 12:14:57
...
if 0
   cv_ = {54.27754045218, 8.496366094878, 15.62628644535};
   cf_ = cfit(ft_,cv_{:});
end
