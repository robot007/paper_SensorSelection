function SensorFit2D1002StdQuadRobust(dist,std)
%SENSORFIT2D1002STDQUADROBUST    Create plot of datasets and fits
%   SENSORFIT2D1002STDQUADROBUST(DIST,STD)
...
%    Unweighted
%
% This function was automatically generated on 02-Oct-2006 12:12:59
...
if 0
   cv_ = {0.04576577512514, -3.626239344813, 82.39907539049};
   cf_ = cfit(ft_,cv_{:});
end
