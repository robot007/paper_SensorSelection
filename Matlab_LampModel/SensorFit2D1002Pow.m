function SensorFit2D1002Pow(dist,bri)
%SENSORFIT2D1002POW    Create plot of datasets and fits
%   SENSORFIT2D1002POW(DIST,BRI)
...
%    Unweighted
%
% This function was automatically generated on 02-Oct-2006 12:05:12
...
if 0
   cv_ = {-762.9978526716, 0.489611763564, 6908.080479505};
   cf_ = cfit(ft_,cv_{:});
end
