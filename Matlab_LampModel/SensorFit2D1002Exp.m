function SensorFit2D1002Exp(dist,bri)
%SENSORFIT2D1002EXP    Create plot of datasets and fits
%   SENSORFIT2D1002EXP(DIST,BRI)
...
%    Unweighted
%
% This function was automatically generated on 02-Oct-2006 12:06:46
...
st_ = [6551.798936959 -0.02861269580161 ];
ft_ = fittype('exp1');

% Fit this model using new data
cf_ = fit(dist(ok_),bri(ok_),ft_,'Startpoint',st_);

% Or use coefficients from the original fit:
if 0
   cv_ = {6462.555016136, -0.02824534402084};
   cf_ = cfit(ft_,cv_{:});
end
